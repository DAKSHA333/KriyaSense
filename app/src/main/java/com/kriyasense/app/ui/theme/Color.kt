...
val PrimaryPurple = Color(0xFF6D3CCF)
val VibrantPurple = Color(0xFF8B5CF6)
val Lavender = Color(0xFFB79CFF)
val PaleLavender = Color(0xFFD8CBFF)
val PrimaryText = Color(0xFFF7F4FF)
val SecondaryText = Color(0xFFB8AEC9)
